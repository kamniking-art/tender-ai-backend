...
async def run_eis_site_once(
    ...
    return {
        ...
        "region_filter": stats.region_filter,
        "region_filter_applied": stats.region_filter_applied,
        "candidates_before_region_filter": stats.candidates_before_region_filter,
        "candidates_after_region_filter": stats.candidates_after_region_filter,
